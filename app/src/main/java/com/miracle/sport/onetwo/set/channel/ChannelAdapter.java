...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public void setmMyChannelItems(List<ChannelEntity> mMyChannelItems) {
        this.mMyChannelItems = mMyChannelItems;
    }
    ...
    public void setmOtherChannelItems(List<ChannelEntity> mOtherChannelItems) {
        this.mOtherChannelItems = mOtherChannelItems;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.channel_item_my_channel_header, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.channel_item_other_channel_header, parent, false);
    ...
    private void startEditMode(RecyclerView parent) {
        ...
        if(onEditChangeListener != null)
            onEditChangeListener.onEditChange(isEditMode);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public void onItemSelected() {
            textView.setBackgroundResource(R.drawable.channel_bg_channel_p);
        }
        ...
        public void onItemFinish() {
            textView.setBackgroundResource(R.drawable.channel_bg_channel);
        }
    }
