...
public class LotteryCategoryListAdapter extends RecyclerViewAdapter<LotteryCatListItem> {
    ...
    public LotteryCategoryListAdapter(Context mContext) {
    ...
    protected void convert(BaseViewHolder helper, LotteryCatListItem item) {
        ...
        if(!isLoadSingle){
            ...
            helper.getView(R.id.tvLdName).setVisibility(View.VISIBLE);
            helper.getView(R.id.tvLdTime).setVisibility(View.VISIBLE);
            helper.getView(R.id.tvLdNum).setVisibility(View.VISIBLE);
            helper.getView(R.id.item_top_continer).setVisibility(View.VISIBLE);
        }else{
